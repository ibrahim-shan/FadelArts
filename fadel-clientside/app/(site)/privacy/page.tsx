      ...
      <section className="relative overflow-hidden bg-secondary/50">
        <div className="container py-12 md:py-16">
          ...
          <Reveal as="p" className="mt-3 text-center text-muted-foreground max-w-2xl mx-auto">
            Your privacy matters to us. This policy explains what we collect, why we collect it, and how we protect it.
          </Reveal>
        </div>
      </section>
          ...
          <Reveal>
            <div className="space-y-8 md:space-y-10">
              <div>
                ...
                <p>
                  This Privacy Policy describes how Fadel Art Shop ("we", "our", or "us") collects, uses, and shares
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>Order information and payment status (processed via third-party providers).</li>
              ...
              <div>
                ...
                <ul>
                  <li>To provide and improve our services, fulfill orders, and process payments.</li>
                  <li>To communicate with you about orders, updates, and promotions (with consent).</li>
              ...
              <div>
                ...
                <p>
                  We use cookies and similar technologies to remember preferences and analyze site traffic. You can
              ...
              <div>
                ...
                <p>
                  We may share information with service providers (e.g., payment processors, analytics) who help us
                  operate the site. We do not sell your personal data.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  We implement reasonable technical and organizational measures to protect personal information, but no
              ...
              <div>
                ...
                <p>
                  Questions about this policy? Contact us via the details on our Contact page.
                </p>
              </div>
            </div>
          </Reveal>
